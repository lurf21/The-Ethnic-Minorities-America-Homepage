...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '2d4a04e00fbe402d874d4daf4bf28f90',
  ...
  AUTHOR: '黄清华', // 作者
  BIO: '', // 作者简介
  LINK: 'https://the-ethnic-minorities-america-homepage.vercel.app/', // 网站地址
  KEYWORDS: '', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'huangqh@mail.tsinghua.edu.cn', // 邮箱
